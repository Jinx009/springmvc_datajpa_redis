...
import com.code.constants.SignTypeEnum;
import com.code.tool.pay.security.Md5Algorithm;
import com.code.tool.pay.security.TraderRSAUtil;
...
public class LLPayUtil{
    ...
    {
        Date date = new Date();
        String timeString = getDateTimeStr(date);
        return timeString;
    }

    /**
     * 获取时间str，格式yyyyMMddHHmmss
     * @return
     * @author guoyx
     */
