...
public class LogAspect {     
	...
	@Before("execution(* com.code.controller.LoginController.loginPost(..))")
     ...
     * @param parame
     */
	@AfterReturning(returning="parame",pointcut="execution(* com.code.controller.LoginController.loginPost(..))")
