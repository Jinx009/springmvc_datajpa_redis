...
<html>
    ...
    <body>
        ...
        <section class="info">
         <form action="<%=path %>prepositPay/toPay" method="post" name="payForm">
        ...
        <footer class="warp footer">
            <img src="/static/pay/images/logo.png" /> <span>连连支付版权所有 2004-2017　浙B2-20080148</span>
        </footer>
...
function queryUserCard() {
    ...
    ajaxFunction('<%=path %>prepositPay/infoQuery?operate=query_bankcard_list&user_id=' + user_id, 'query_bankcard_list');

}
function queryCardBin(card_no) {
    ajaxFunction('<%=path %>prepositPay/infoQuery?operate=query_card_bin&card_no=' + card_no, 'query_card_bin');
