...
<html>
    <head>        
		...
		<link href="/static/DataTables-1.10.7/media/css/jquery.dataTables.min.css"/>
		<script>
		var rootPath ="${ctx}/";
		</script>
		<sitemesh:head />
        <link rel="stylesheet" id="theme" href="/static/css/theme-default.css"/>
    </head>
    <body>
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">金克丝</div>
                            </div>
                        </div>                                                                        
                    </li>
